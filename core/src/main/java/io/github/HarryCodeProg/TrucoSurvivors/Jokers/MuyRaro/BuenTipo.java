...
public class BuenTipo extends Joker {

    public BuenTipo() {
        super(102, "BuenTipo", "BuenTipo", "Reactiva todos los jokers con categoría 'AMIGABLE'",
            Rareza.muyRaro, 8, Joker.FaseActivacion.INDEPENDIENTE,
            CategoriaJoker.AMIGABLE);
    }

    @Override
    public Joker copiar() {
        BuenTipo copia = new BuenTipo();
        copiarEstado(copia);
        return copia;
    }
    ...
    public void aplicarEfecto(EventoJuego evento, ContextoJuego ctx, Juego juego) {
        ...
        for (Joker j : jokers) {
            ...
            if (j.tieneCategoria(CategoriaJoker.AMIGABLE)) {
