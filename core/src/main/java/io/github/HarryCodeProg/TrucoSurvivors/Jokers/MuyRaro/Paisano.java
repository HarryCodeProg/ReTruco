...
public class Paisano extends Joker {

    public Paisano() {
        super(113, "Paisano", "Paisano", "Reactiva todos los jokers con categoría 'CAMPO'",
    ...
    public void aplicarEfecto(EventoJuego evento, ContextoJuego ctx, Juego juego) {
        ...
        for (Joker j : jokers) {
            if (j == this) continue;
            if (j.tieneCategoria(CategoriaJoker.CAMPO)) {
